            ...
            <div id="about" className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col md:flex-row gap-16">
                ...
                <div className="md:w-1/2 lg:w-[54%] space-y-8">
                    <h1 className="text-gray-900 font-bold text-3xl sm:text-4xl md:text-5xl">
                        Empowering Learning with <span className="text-purple-600">Panda Buddy</span>
                    </h1>
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                        ...
                        <BackgroundGradient className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-white dark:bg-zinc-900">
                            ...
                            <h2 className="font-bold text-xl text-gray-900">Our Mission</h2>
                        ...
                        <BackgroundGradient className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-white dark:bg-zinc-900">
                            <span className="inline-block rounded-full bg-blue-600 text-white p-3">
                                <Eye className="w-6 h-6" />
                            </span>
                            <h2 className="font-bold text-xl text-gray-900">Our Vision</h2>
                            <p className="text-gray-700">
